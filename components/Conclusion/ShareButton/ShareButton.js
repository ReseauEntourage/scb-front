  ...
  return (
    <div className="buttons-container">
      ...
      <div className="button__social__sharing-container">
        <a
          href={
            "fb-messenger://share/?link=https://video-react.js.org/&app_id=123456789"
          }
        >
          <div className="share-button messenger-share__button">
            <div className="share-button__icon__text--container">
              ...
              <span
                className="button__text messenger"
                style={{ color: "#" + color }}
              >
                Messenger
              </span>
        ...
        <a
          href={"https://api.whatsapp.com/send?text=https://video-react.js.org"}
        ...
        >
          <div className="share-button whatsapp-share__button">
            <div className="share-button__icon__text--container">
              ...
              <span
                className="button__text whatsapp"
                style={{ color: "#" + color }}
              >
                Whatsapp
              </span>
